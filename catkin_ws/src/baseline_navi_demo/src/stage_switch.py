...
import rospy
from baseline_navi_demo.srv import StageChange, StageChangeResponse
from baseline_navi_demo.srv import Stage_Grasp, Stage_GraspResponse
from baseline_navi_demo.srv import Stage_Totag, Stage_TotagResponse
...
class StageSwitch(object):
    def __init__(self):
        ...
        rospy.wait_for_service('baseline_navi_demo/stage_grasp')
        self.grasp_service = rospy.ServiceProxy('baseline_navi_demo/stage_grasp', Stage_Grasp)
        rospy.wait_for_service('baseline_navi_demo/stage_totag')
        self.totag_service = rospy.ServiceProxy('baseline_navi_demo/stage_totag', Stage_Totag)
